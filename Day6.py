...
def findMarker(input, noOfDistinctChars):
        for i in range(len(input) - noOfDistinctChars - 1):
                if len(set(input[i: i + noOfDistinctChars])) == noOfDistinctChars:
                        # print(input[i: i + noOfDistinctChars])
                        return i + noOfDistinctChars
        return 0

star1Answer = findMarker(input, 4)
star2Answer = findMarker(input, 14)

print("star1Answer = ", star1Answer)
print("star2Answer = ", star2Answer)
